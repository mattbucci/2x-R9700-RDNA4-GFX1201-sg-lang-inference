...
3. **256K single-user context sweeps (partial data gathered)** — Numbers so far (TPOT-based, FP8 KV, --disable-cuda-graph):
   ...
   - **Qwen3.5-35B MoE GPTQ**: 14-16 tok/s @ 128-8K → 14.4 tok/s @ 16K → 16.7 tok/s @ 32K → 14.7 tok/s @ 65K → **15.3 tok/s @ 131K, TTFT 27s**.  MoE+DeltaNet holds up better at long context than pure dense.
