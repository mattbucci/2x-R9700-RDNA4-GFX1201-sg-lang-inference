#!/bin/bash
# Launch Gemma 4 26B-A4B-it BF16 on 2x R9700 TP=2
# Diagnostic: validates model code works before fixing quantization
# BF16 = 49GB, fits in 2x32GB with small context
cd /home/letsrtfm/AI/rdna4-inference-triton36
source scripts/common.sh
activate_conda
setup_rdna4_env
exec python -m sglang.launch_server \
    --model-path /home/letsrtfm/AI/models/gemma-4-26B-A4B-it-BF16 \
    --tensor-parallel-size 2 --dtype bfloat16 \
    --kv-cache-dtype fp8_e4m3 --context-length 2048 \
    --mem-fraction-static 0.55 --disable-cuda-graph \
